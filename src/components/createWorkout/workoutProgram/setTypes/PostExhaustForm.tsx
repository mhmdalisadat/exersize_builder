...
export interface PostExhaustData {
...
interface PostExhaustFormProps {
  onSave: (data: PostExhaustData) => void;
}

const PostExhaustForm: React.FC<PostExhaustFormProps> = ({ onSave }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 space-y-6 bg-white p-6 rounded-lg shadow-sm">
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-800 mb-4">تنظیمات پس خستگی</h3>
        ...
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
          <h4 className="text-md font-medium text-gray-800 mb-4">تمرین ترکیبی (اول)</h4>
        ...
        {/* Isolation Exercise */}
        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
          <h4 className="text-md font-medium text-gray-800 mb-4">تمرین ایزوله (دوم)</h4>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                نام تمرین
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          <h4 className="text-md font-medium text-blue-800 mb-2">نکات مهم پس خستگی</h4>
          <ul className="list-disc list-inside text-sm text-blue-700 space-y-1">
            <li>ابتدا تمرین ترکیبی را با وزنه سنگین انجام دهید</li>
            <li>در تمرین ترکیبی، وزنه را طوری انتخاب کنید که بتوانید 8-12 تکرار انجام دهید</li>
            <li>استراحت کوتاه بین تمرین ترکیبی و ایزوله (45-60 ثانیه)</li>
            <li>در تمرین ایزوله، وزنه را متناسب با خستگی عضله تنظیم کنید</li>
...
export default PostExhaustForm;